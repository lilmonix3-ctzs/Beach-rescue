...
Shader "RimLight_Circle"
{
	Properties
	{
		...
		[ASEEnd]_Intensity("Intensity", Range( 0 , 0.99)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float saferPower17 = abs( ( distance( texCoord12 , float2( 0.5,0.5 ) ) * 2.0 ) );
				float smoothstepResult26 = smoothstep( 0.0 , 1.0 , pow( saferPower17 , 20.0 ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _RimColor * smoothstepResult26 * _Intensity ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
15.33333;528;1382;623.6667;194.9462;141.3129;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-838.3488,20.40167;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;207.9885,-242.7975;Inherit;False;Property;_RimColor;RimColor;0;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;569.2863,-20.80316;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SmoothstepOpNode;26;283.687,39.58211;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;17;41.36121,109.472;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-51.31317,375.7158;Inherit;False;Property;_Intensity;Intensity;1;0;Create;True;0;0;0;False;0;False;0;0;0;0.99;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-200.4389,273.272;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;20;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-512.7195,248.1632;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-309.3861,126.1632;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;16;-798.3488,211.0683;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DistanceOpNode;13;-523.6822,93.73502;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=A45294C3EF2691B9B93FFC5C18D283C20E221026